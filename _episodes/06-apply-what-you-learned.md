...
exercises: 60
questions:
- "How to apply what we have learned to web APIs we need to use?"
objectives:
- "Interact with another web API that is useful to your work."
---

> ## Try out some other APIs
>
> Apply what you have learned today to access a web API that might be useful 
> 
> Here are a few APIs that you might be useful to you:
>
> * [The Environmental Data Service's data citation API][eds-api]
...
[eds-api]: https://www.bodc.ac.uk/eds-citation/docs#/
